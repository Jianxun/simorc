...
C {devices/vsource.sym} -420 70 0 0 {name=V2 value=\{vdda\} savecurrent=false}
...
C {devices/isource.sym} -160 170 3 0 {name=I0 value=\{ibias\}}
...
C {devices/code_shown.sym} 190 -320 0 0 {name=Simulation only_toplevel=false value="
.control
save all

OP
show all > \{\{config.filename_log\}\}

DC V3 0 \{\{config.parameters.vdda\}\} 0.01
write \{\{config.filename_raw\}\}

.endc
"}
C {devices/code_shown.sym} -440 -300 0 0 {name=Models only_toplevel=false
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice \{\{config.parameters.corner\}\}
"}
C {libs/core_analog/ota_5t/ota_5t.sym} 0 0 0 0 {name=x1}
C {devices/code_shown.sym} -440 -190 0 0 {name=Params only_toplevel=false
format="tcleval( @value )"
value="
.param vdda=\{\{config.parameters.vdda\}\}
.param ibias=\{\{config.parameters.ibias\}\}
"}
